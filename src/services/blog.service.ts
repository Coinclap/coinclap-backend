...
export class BlogService extends BaseService {
  ...
  public async getAllBlogs(
    ...
    try {
      ...
      const result = await this.blogRepository.searchBlogs(searchTerm || "", categoryId, paginationOptions)
  ...
  public async createBlog(blogData: IBlogCreateData, authorId: string): Promise<IServiceResponse<IBlogDocument>> {
    try {
      // Validate category
  ...
  public async updateBlog(
    ...
    try {
      ...
      if (!updatedBlog) {
        return this.createErrorResponse("Failed to update blog", HttpStatusCode.INTERNAL_SERVER_ERROR)
      }
  ...
  public async deleteBlog(id: string): Promise<IServiceResponse<IBlogDocument>> {
    try {
      ...
      if (!deletedBlog) {
        return this.createErrorResponse("Failed to delete blog", HttpStatusCode.INTERNAL_SERVER_ERROR)
      }
  ...
  public async publishBlog(id: string): Promise<IServiceResponse<IBlogDocument>> {
    try {
      ...
      if (!publishedBlog) {
        return this.createErrorResponse("Failed to publish blog", HttpStatusCode.INTERNAL_SERVER_ERROR)
      }
  ...
  public async unpublishBlog(id: string): Promise<IServiceResponse<IBlogDocument>> {
    try {
      ...
      if (!unpublishedBlog) {
        return this.createErrorResponse("Failed to unpublish blog", HttpStatusCode.INTERNAL_SERVER_ERROR)
      }
