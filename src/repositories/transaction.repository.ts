...
import { type ITransactionDocument, TransactionModel, TransactionStatus } from "../models/transaction.model"
...
export class TransactionRepository extends BaseRepository<ITransactionDocument> {
  ...
  public async findSuccessfulTransactionByEmail(email: string): Promise<ITransactionDocument | null> {
  ...
  public async updateTransactionStatus(
    ...
    paymentDetails?: { paymentId?: string; redeemCode?: string; invoiceNo?: string; expiryDate?: Date },
